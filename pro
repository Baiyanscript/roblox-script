...
Frame.Position = UDim2.new(0.5, -105, 0.5, -125)
...
SpeedFrame.Size = UDim2.new(1, 0, 0, 28); SpeedFrame.Position = UDim2.new(0, 0, 0, 6)
...
JumpFrame.Size = UDim2.new(1, 0, 0, 28); JumpFrame.Position = UDim2.new(0, 0, 0, 40)
...
FlyFrame.Size = UDim2.new(1, 0, 0, 28); FlyFrame.Position = UDim2.new(0, 0, 0, 74)
...
FlyToggleFrame.Size = UDim2.new(1, 0, 0, 28); FlyToggleFrame.Position = UDim2.new(0, 0, 0, 108)
...
HeightFrame.Size = UDim2.new(1, 0, 0, 28); HeightFrame.Position = UDim2.new(0, 0, 0, 142)
...
SettingsBtn.MouseButton1Click:Connect(function()
    ...
    if isMinimized then
        isMinimized = false
        TweenService:Create(Frame, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Size = UDim2.new(0, 210, 0, 250)}):Play()
...
TweenService:Create(Frame, TweenInfo.new(0.1, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
    ...
    Position = UDim2.new(0.5, -105, 0.5, -125)
}):Play()
