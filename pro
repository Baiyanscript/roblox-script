...
local MaxJumps = 5          -- 預設跳躍次數設為 5
local JumpCount = 0
local CurrentSpeed = 16

-- 飛行系統狀態（完整對應 FlyGuiV3）
local FlyActive = false     -- 對應原腳本的 nowe
local FlySpeedValueNum = 1  -- 對應原腳本的 speeds
local tpwalking = false
local tis = nil            -- 向上循環連線
local dis = nil            -- 向下循環連線
local bg = nil
local bv = nil
...
Frame.Position = UDim2.new(0.5, -105, 0.5, -145)
...
SettingsBtn.Size = UDim2.new(0, 26, 0, 26); SettingsBtn.Position = UDim2.new(1, -86, 0.5, -13)
SettingsBtn.BackgroundColor3 = Themes.Dark.TopButtons; SettingsBtn.Text = "⚙"; SettingsBtn.TextColor3 = Themes.Dark.Text
SettingsBtn.Font = Enum.Font.GothamBold; SettingsBtn.TextSize = 14; SettingsBtn.BorderSizePixel = 0
Instance.new("UICorner", SettingsBtn).CornerRadius = UDim.new(0, 6)

local MinimizeBtn = Instance.new("TextButton", TitleBar)
MinimizeBtn.Size = UDim2.new(0, 26, 0, 26); MinimizeBtn.Position = UDim2.new(1, -57, 0.5, -13)
MinimizeBtn.BackgroundColor3 = Themes.Dark.TopButtons; MinimizeBtn.Text = "−"; MinimizeBtn.TextColor3 = Themes.Dark.Text
MinimizeBtn.Font = Enum.Font.GothamBold; MinimizeBtn.TextSize = 14; MinimizeBtn.BorderSizePixel = 0
...
CloseBtn.Font = Enum.Font.GothamBold; CloseBtn.TextSize = 18; CloseBtn.BorderSizePixel = 0
Instance.new("UICorner", CloseBtn).CornerRadius = UDim.new(0, 6)

-- 內容量
local Content = Instance.new("Frame", Frame)
Content.Size = UDim2.new(1, -14, 1, -48); Content.Position = UDim2.new(0, 7, 0, 41)
...
SpeedFrame.Size = UDim2.new(1, 0, 0, 34); SpeedFrame.Position = UDim2.new(0, 0, 0, 8)
SpeedFrame.BackgroundTransparency = 1

local DecSpeed = Instance.new("TextButton", SpeedFrame)
DecSpeed.Size = UDim2.new(0, 32, 1, 0); DecSpeed.Text = "−"; DecSpeed.Font = Enum.Font.GothamBold; DecSpeed.TextSize = 15
DecSpeed.BackgroundColor3 = Themes.Dark.Button; DecSpeed.TextColor3 = Themes.Dark.Text; DecSpeed.BorderSizePixel = 0
Instance.new("UICorner", DecSpeed).CornerRadius = UDim.new(0, 6)

local SpeedInput = Instance.new("TextBox", SpeedFrame)
SpeedInput.Size = UDim2.new(1, -72, 1, 0); SpeedInput.Position = UDim2.new(0, 36, 0, 0)
SpeedInput.Text = "速度: 16"; SpeedInput.Font = Enum.Font.GothamBold; SpeedInput.TextSize = 12
...
IncSpeed.Size = UDim2.new(0, 32, 1, 0); IncSpeed.Position = UDim2.new(1, -32, 0, 0); IncSpeed.Text = "+"; IncSpeed.Font = Enum.Font.GothamBold; IncSpeed.TextSize = 15
IncSpeed.BackgroundColor3 = Themes.Dark.Button; IncSpeed.TextColor3 = Themes.Dark.Text; IncSpeed.BorderSizePixel = 0
Instance.new("UICorner", IncSpeed).CornerRadius = UDim.new(0, 6)

-- 2. 跳躍次數組合框
local JumpFrame = Instance.new("Frame", Content)
JumpFrame.Size = UDim2.new(1, 0, 0, 34); JumpFrame.Position = UDim2.new(0, 0, 0, 50)
JumpFrame.BackgroundTransparency = 1

local DecJump = Instance.new("TextButton", JumpFrame)
DecJump.Size = UDim2.new(0, 32, 1, 0); DecJump.Text = "−"; DecJump.Font = Enum.Font.GothamBold; DecJump.TextSize = 15
DecJump.BackgroundColor3 = Themes.Dark.Button; DecJump.TextColor3 = Themes.Dark.Text; DecJump.BorderSizePixel = 0
Instance.new("UICorner", DecJump).CornerRadius = UDim.new(0, 6)

local JumpInput = Instance.new("TextBox", JumpFrame)
JumpInput.Size = UDim2.new(1, -72, 1, 0); JumpInput.Position = UDim2.new(0, 36, 0, 0)
JumpInput.Text = "跳躍: 5"; JumpInput.Font = Enum.Font.GothamBold; JumpInput.TextSize = 12
...
IncJump.Size = UDim2.new(0, 32, 1, 0); IncJump.Position = UDim2.new(1, -32, 0, 0); IncJump.Text = "+"; IncJump.Font = Enum.Font.GothamBold; IncJump.TextSize = 15
IncJump.BackgroundColor3 = Themes.Dark.Button; IncJump.TextColor3 = Themes.Dark.Text; IncJump.BorderSizePixel = 0
Instance.new("UICorner", IncJump).CornerRadius = UDim.new(0, 6)

-- 3. 飛行控制組合框 (已全面整合 TextBox 打字輸入與加減按鈕)
local FlyFrame = Instance.new("Frame", Content)
FlyFrame.Size = UDim2.new(1, 0, 0, 34); FlyFrame.Position = UDim2.new(0, 0, 0, 92)
FlyFrame.BackgroundTransparency = 1

local DecFly = Instance.new("TextButton", FlyFrame)
DecFly.Size = UDim2.new(0, 32, 1, 0); DecFly.Text = "−"; DecFly.Font = Enum.Font.GothamBold; DecFly.TextSize = 15
DecFly.BackgroundColor3 = Themes.Dark.Button; DecFly.TextColor3 = Themes.Dark.Text; DecFly.BorderSizePixel = 0
Instance.new("UICorner", DecFly).CornerRadius = UDim.new(0, 6)

local FlySpeedInput = Instance.new("TextBox", FlyFrame)
FlySpeedInput.Size = UDim2.new(1, -72, 1, 0); FlySpeedInput.Position = UDim2.new(0, 36, 0, 0)
FlySpeedInput.Text = "飛速: 1"; FlySpeedInput.Font = Enum.Font.GothamBold; FlySpeedInput.TextSize = 12
...
IncFly.Size = UDim2.new(0, 32, 1, 0); IncFly.Position = UDim2.new(1, -32, 0, 0); IncFly.Text = "+"; IncFly.Font = Enum.Font.GothamBold; IncFly.TextSize = 15
IncFly.BackgroundColor3 = Themes.Dark.Button; IncFly.TextColor3 = Themes.Dark.Text; IncFly.BorderSizePixel = 0
Instance.new("UICorner", IncFly).CornerRadius = UDim.new(0, 6)

-- 4. 飛行開關按鈕
local FlyToggleFrame = Instance.new("Frame", Content)
FlyToggleFrame.Size = UDim2.new(1, 0, 0, 34); FlyToggleFrame.Position = UDim2.new(0, 0, 0, 134)
FlyToggleFrame.BackgroundTransparency = 1

local FlyToggleBtn = Instance.new("TextButton", FlyToggleFrame)
FlyToggleBtn.Size = UDim2.new(1, 0, 1, 0); FlyToggleBtn.Text = "飛行狀態: 關閉"; FlyToggleBtn.Font = Enum.Font.GothamBold; FlyToggleBtn.TextSize = 12
FlyToggleBtn.BackgroundColor3 = Themes.Dark.Button; FlyToggleBtn.TextColor3 = Themes.Dark.Text; FlyToggleBtn.BorderSizePixel = 0
Instance.new("UICorner", FlyToggleBtn).CornerRadius = UDim.new(0, 7)

-- 5. 高度調整微調鈕
local HeightFrame = Instance.new("Frame", Content)
HeightFrame.Size = UDim2.new(1, 0, 0, 34); HeightFrame.Position = UDim2.new(0, 0, 0, 176)
...
Credit.Size = UDim2.new(1, 0, 0, 20); Credit.Position = UDim2.new(0, 0, 1, -2)
Credit.Text = "by: romokaso & Baiyan"; Credit.TextColor3 = Color3.fromRGB(110, 110, 110)
Credit.BackgroundTransparency = 1; Credit.Font = Enum.Font.GothamBold; Credit.TextSize = 9
...
SettingsTitle.Size = UDim2.new(1, 0, 0, 40); SettingsTitle.Position = UDim2.new(0, 0, 0, 10); SettingsTitle.Text = "SETTINGS"
SettingsTitle.TextColor3 = Themes.Dark.Text; SettingsTitle.BackgroundTransparency = 1; SettingsTitle.Font = Enum.Font.GothamBold; SettingsTitle.TextSize = 14; SettingsTitle.ZIndex = 21

local ThemeLabel = Instance.new("TextLabel", SettingsFrame)
ThemeLabel.Size = UDim2.new(1, -20, 0, 25); ThemeLabel.Position = UDim2.new(0, 10, 0, 60); ThemeLabel.Text = "THEME:"
ThemeLabel.TextColor3 = Themes.Dark.Text; ThemeLabel.BackgroundTransparency = 1; ThemeLabel.Font = Enum.Font.GothamBold; ThemeLabel.TextSize = 12; ThemeLabel.TextXAlignment = Enum.TextXAlignment.Left; ThemeLabel.ZIndex = 21

local DarkThemeBtn = Instance.new("TextButton", SettingsFrame)
DarkThemeBtn.Size = UDim2.new(0.45, -5, 0, 32); DarkThemeBtn.Position = UDim2.new(0, 10, 0, 90); DarkThemeBtn.BackgroundColor3 = Color3.fromRGB(50, 150, 100); DarkThemeBtn.Text = "DARK"; DarkThemeBtn.TextColor3 = Color3.new(1, 1, 1); DarkThemeBtn.Font = Enum.Font.GothamBold; DarkThemeBtn.TextSize = 12; DarkThemeBtn.BorderSizePixel = 0; DarkThemeBtn.ZIndex = 21
Instance.new("UICorner", DarkThemeBtn).CornerRadius = UDim.new(0, 7)

local LightThemeBtn = Instance.new("TextButton", SettingsFrame)
LightThemeBtn.Size = UDim2.new(0.45, -5, 0, 32); LightThemeBtn.Position = UDim2.new(0.55, 0, 0, 90); LightThemeBtn.BackgroundColor3 = Themes.Dark.Button; LightThemeBtn.Text = "LIGHT"; LightThemeBtn.TextColor3 = Themes.Dark.Text; LightThemeBtn.Font = Enum.Font.GothamBold; LightThemeBtn.TextSize = 12; LightThemeBtn.BorderSizePixel = 0; LightThemeBtn.ZIndex = 21
Instance.new("UICorner", LightThemeBtn).CornerRadius = UDim.new(0, 7)

local BackBtn = Instance.new("TextButton", SettingsFrame)
BackBtn.Size = UDim2.new(0.9, 0, 0, 32); BackBtn.Position = UDim2.new(0.05, 0, 1, -45); BackBtn.BackgroundColor3 = Color3.fromRGB(255, 80, 80); BackBtn.Text = "BACK"; BackBtn.TextColor3 = Color3.new(1, 1, 1); BackBtn.Font = Enum.Font.GothamBold; BackBtn.TextSize = 13; BackBtn.BorderSizePixel = 0; BackBtn.ZIndex = 21
...
ConfirmStroke.Thickness = 3; ConfirmStroke.Color = Themes.Dark.Border

local ConfirmText = Instance.new("TextLabel", ConfirmFrame)
ConfirmText.Size = UDim2.new(1, -20, 0, 60); ConfirmText.Position = UDim2.new(0, 10, 0, 90); ConfirmText.Text = "Are you sure you want\nto close the GUI?"
ConfirmText.TextColor3 = Themes.Dark.Text; ConfirmText.BackgroundTransparency = 1; ConfirmText.Font = Enum.Font.GothamBold; ConfirmText.TextSize = 13; ConfirmText.ZIndex = 26

local YesBtn = Instance.new("TextButton", ConfirmFrame)
YesBtn.Size = UDim2.new(0, 80, 0, 32); YesBtn.Position = UDim2.new(0, 15, 1, -45); YesBtn.BackgroundColor3 = Color3.fromRGB(50, 180, 100); YesBtn.Text = "YES"; YesBtn.TextColor3 = Color3.fromRGB(255, 255, 255); YesBtn.Font = Enum.Font.GothamBold; YesBtn.TextSize = 13; YesBtn.BorderSizePixel = 0; YesBtn.ZIndex = 26
Instance.new("UICorner", YesBtn).CornerRadius = UDim.new(0, 7)

local NoBtn = Instance.new("TextButton", ConfirmFrame)
NoBtn.Size = UDim2.new(0, 80, 0, 32); NoBtn.Position = UDim2.new(1, -95, 1, -45); NoBtn.BackgroundColor3 = Color3.fromRGB(255, 80, 80); NoBtn.Text = "NO"; NoBtn.TextColor3 = Color3.fromRGB(255, 255, 255); NoBtn.Font = Enum.Font.GothamBold; NoBtn.TextSize = 13; NoBtn.BorderSizePixel = 0; NoBtn.ZIndex = 26
...
SettingsBtn.MouseButton1Click:Connect(function()
    ...
    if isMinimized then
        isMinimized = false
        TweenService:Create(Frame, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Size = UDim2.new(0, 210, 0, 290)}):Play()
...
MinimizeBtn.MouseButton1Click:Connect(function()
    ...
    if isMinimized then
        TweenService:Create(Frame, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Size = UDim2.new(0, 210, 0, 35)}):Play()
        MinimizeBtn.Text = "+"
    else
        TweenService:Create(Frame, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Size = UDim2.new(0, 210, 0, 290)}):Play()
        MinimizeBtn.Text = "−"
...
TweenService:Create(Frame, TweenInfo.new(0.1, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
    ...
    Position = UDim2.new(0.5, -105, 0.5, -145)
}):Play()
