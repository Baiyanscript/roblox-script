...
local function createESP(targetPlayer)
    ...
    local function updateESP()
        if not ESPActive or not targetPlayer.Character or not targetPlayer.Character:FindFirstChild("HumanoidRootPart") or not targetPlayer.Character:FindFirstChild("Humanoid") then
            if espObjects[targetPlayer] then
        ...
        if onScreen then
            ...
            if ESPBoxActive then
                ...
                local box = espObjects[targetPlayer].BoxFrame
                box.Visible = true
