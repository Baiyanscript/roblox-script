-- Yet Another Baiyan Hub Menu 1.21
...
local Converted = {
	["_Baiyan"] = Instance.new("ScreenGui");
...
Converted["_Baiyan"].DisplayOrder = 3
Converted["_Baiyan"].IgnoreGuiInset = true
Converted["_Baiyan"].ScreenInsets = Enum.ScreenInsets.DeviceSafeInsets
Converted["_Baiyan"].ResetOnSpawn = false
Converted["_Baiyan"].ZIndexBehavior = Enum.ZIndexBehavior.Sibling
Converted["_Baiyan"].Name = "Baiyan"
Converted["_Baiyan"].Parent = game:GetService("CoreGui")

Converted["_Open"].Font = Enum.Font.Gotham
Converted["_Open"].Text = "Triple-click this region to open Baiyan."
...
Converted["_Open"].Parent = Converted["_Baiyan"]
...
Converted["_DropdownFrameSample"].Parent = Converted["_Baiyan"]
...
Converted["_ListButton"].Parent = Converted["_Baiyan"]
...
Converted["_Notifications"].Parent = Converted["_Baiyan"]
...
Converted["_TextBoxPlaceholder"].Parent = Converted["_Baiyan"]
...
Converted["_FloatingButton"].Parent = Converted["_Baiyan"]
...
Converted["_Dropdown"].Parent = Converted["_Baiyan"]
...
Converted["_AddCustomModule"].Parent = Converted["_Baiyan"]
...
Converted["_Menu"].Parent = Converted["_Baiyan"]
...
Converted["_HubDesc"].Text = "yet another Baiyan hub menu"
...
Converted["_HubName"].Text = "Baiyan "
...
Converted["_TextLabel4"].Text = "Yet Another Baiyan Hub Menu"
...
Converted["_TextLabel7"].Text = "Baiyan"
...
Converted["_Toggle"].Parent = Converted["_Baiyan"]
...
Converted["_Modules"].Parent = Converted["_Baiyan"]
...
Converted["_NotificationSample"].Parent = Converted["_Baiyan"]
...
Converted["_Dialog"].Parent = Converted["_Baiyan"]
...
Converted["_Range"].Parent = Converted["_Baiyan"]
...
Converted["_FloatingButtonSetting"].Parent = Converted["_Baiyan"]
...
Converted["_FloatingButtons1"].Parent = Converted["_Baiyan"]

-- Routine Module Scripts:

local routine_module_scripts = {}

do -- Routine Module: StarterGui.Baiyan.FUNCTIONS
    local script = Instance.new("ModuleScript")
    script.Name = "FUNCTIONS"
    script.Parent = Converted["_Baiyan"]
    local function module_script()
		...
		function SBTf()
			...
			-- Implementation by Baiyan Team, respective credits towards the original creators for spring physics
		...
		local BaiyanPointSave = PointSave.new("Baiyan")
		...
		function FUNCTIONSmodule.getTheme()
			if getgenv then
				return getgenv().Baiyan_THEME or FUNCTIONSmodule.theme
			else
		...
		function FUNCTIONSmodule.setTheme(t)
			...
			if getgenv then getgenv().Baiyan_THEME = t end
		end
		...
		function FUNCTIONSmodule.finetuneFloatingButton(button: TextButton, dragger)
			...
			fBSFResizeDragger.Dragged = function(pos)
				...
				button.Size = newSize
				BaiyanPointSave:set(string.gsub(button.Name, "_", ""), udim2Serializer(button.Position) .. "|" .. udim2Serializer(button.Size) .. "|" .. tostring(button.Visible) .. "|" .. tostring(dragger.CanBeDragged))
			end
		...
		function FUNCTIONSmodule.ftToggleLock()
			...
			BaiyanPointSave:set(string.gsub(getgenv().fBSFRealButton.Name, "_", ""), udim2Serializer(getgenv().fBSFRealButton.Position) .. "|" .. udim2Serializer(getgenv().fBSFRealButton.Size) .. "|" .. tostring(getgenv().fBSFRealButton.Visible) .. "|" .. tostring(getgenv().fBSF_ButtonDragger.CanBeDragged))
		end
		...
		function FUNCTIONSmodule.createFloatingButton(item,button,buttonname,fromload)
			if not getgenv().Baiyan.FloatingButtons:FindFirstChild(string.gsub(buttonname, "_", "")) then
				
				
				local UserInputService = game:GetService("UserInputService")
				if not fromload then
					BaiyanPointSave:set(string.gsub(buttonname, "_", ""), udim2Serializer(UDim2.fromOffset(125, 90)) .. "|" .. udim2Serializer(UDim2.fromOffset(200,50)) .. "|true|true")
				end
		
				local newFloatingButton = getgenv().Baiyan.FloatingButton:Clone()
				newFloatingButton.Parent = getgenv().Baiyan.FloatingButtons
				...
				elseif BaiyanPointSave:get(string.gsub(buttonname, "_", "")) then
					local data = BaiyanPointSave:get(string.gsub(buttonname, "_", "")):split("|")
				...
				floatingButtonDraggers[string.gsub(buttonname, "_", "")].Dragged = function(newPos)
					BaiyanPointSave:set(string.gsub(buttonname, "_", ""), udim2Serializer(newPos) .. "|" .. udim2Serializer(newFloatingButton.Size) .. "|" .. tostring(newFloatingButton.Visible) .. "|" .. tostring(floatingButtonDraggers[string.gsub(buttonname, "_", "")].CanBeDragged))
				end
				...
				BaiyanPointSave:remove(string.gsub(buttonname, "_", ""))
				task.spawn(function()
					local buttontodestroy = getgenv().Baiyan.FloatingButtons:FindFirstChild(string.gsub(buttonname, "_", ""))
			...
			for _, module in ipairs(getgenv().Modules) do
				for _, item in ipairs(module) do
					if item["Type"] == "Button" then
						...
						local saved = BaiyanPointSave:get(key)
						if saved then
		...
		function FUNCTIONSmodule.loader(module)
			...
			for _, item in ipairs(module) do
				...
				elseif item["Type"] == "Input" then
					local cloneinput = getgenv().Baiyan.TextBoxPlaceholder:Clone()
				...
				elseif item["Type"] == "Toggle" then
					local clonetoggle = getgenv().Baiyan.Toggle:Clone()
				...
				elseif item["Type"] == "Dropdown" then	
					local clonedropdown = getgenv().Baiyan.Dropdown:Clone()
					local dropdownFrame = getgenv().Baiyan.DropdownFrameSample
				...
				elseif item["Type"] == "Range" then
					local clonerange = getgenv().Baiyan.Range:Clone()
		...
		function FUNCTIONSmodule.refreshlist()
			...
			for i, module in ipairs(dense) do
				local success, err = pcall(function()
					...
					local listbutton = getgenv().Baiyan.ListButton:Clone()
				...
				if not success then
					warn(("[Baiyan] Error loading module %q: %s"):format(module.Name, err))
				end
			end
		end
		...
		getgenv().BaiyanFUNCTIONS = FUNCTIONSmodule
		return FUNCTIONSmodule
		
    end
    routine_module_scripts[script] = module_script
end
do -- Routine Module: StarterGui.Baiyan.DraggableObject
    local script = Instance.new("ModuleScript")
...
do -- Routine Module: StarterGui.Baiyan.ClickAndHold
    local script = Instance.new("ModuleScript")
...
do -- Routine Module: StarterGui.Baiyan.Spring
    local script = Instance.new("ModuleScript")
    script.Name = "Spring"
    script.Parent = Converted["_Baiyan"]
    local function module_script()
...
do -- Routine Module: StarterGui.Baiyan.ESPIndicator
    local script = Instance.new("ModuleScript")
    ...
    local function module_script()
		...
		-- Designed and written by Baiyan
...
do -- Routine Module: StarterGui.Baiyan.Bezier
    local script = Instance.new("ModuleScript")
    script.Name = "Bezier"
    script.Parent = Converted["_Baiyan"]
    local function module_script()
...
do -- Routine Module: StarterGui.Baiyan.PointSave
    local script = Instance.new("ModuleScript")
...
do -- Routine Module: StarterGui.Baiyan.Theme
    local script = Instance.new("ModuleScript")
    script.Name = "Theme"
    script.Parent = Converted["_Baiyan"]
    local function module_script()

		-- Beautiful theming module for Baiyan
		
		local BaiyanRoot = getgenv().Baiyan
		local api = {
			colors = {
				font = Enum.Font.Montserrat,
				textColor = Color3.fromRGB(255, 255, 255),
...
do -- Routine Module: StarterGui.Baiyan.FlyUtility
    local script = Instance.new("ModuleScript")
...
local function WMYX_routine() -- Routine: StarterGui.Baiyan.Flee the Facility
...
local function CEBY_routine() -- Routine: StarterGui.Baiyan.Universal
    local script = Instance.new("LocalScript")
	...
	--table.insert(module, {
	--	Type = "Text",
	--	Args = {"Welcome to Baiyan! The open, free script hub."}
	--})
	
	table.insert(module, {
		Type = "Text",
		Args = {"<font color='#FFFF00'>Another great script</font> by Baiyan developers below!"}
	})
	
	table.insert(module, {
		Type = "Button",
		Args = {"AFEM Max - The best AI-powered emote script!", function()
			loadstring(game:HttpGet("https://github.com/Baiyanscript/roblox-script/raw/refs/heads/main/AFEM"))()
	...
	table.insert(module, {
		Type = "Button",
		Args = {"about github", function(Self)
			if setclipboard then setclipboard("https://github.com/Baiyanscript/roblox-script/") end
	...
	table.insert(module, {
		Type = "Button",
		Args = {"Hide Baiyan", function(Self)
			...
			elseif uis.AccelerometerEnabled then
				...
				fu.notification("Can't hide Baiyan!") -- how else are you gonna open???
			end
		end,}
	}
	)
	...
	table.insert(module, {
		...
		Args = {"Open developer console (debugging)", function(Self)
			...
			--getgenv().Baiyan.Open.UIStroke.Transparency = 0
			--getgenv().Baiyan.Open.TextTransparency = 0
			--ts:Create(getgenv().Baiyan.Open, TweenInfo.new(1, Enum.EasingStyle.Cubic, Enum.EasingDirection.Out), {
			--	Position = UDim2.fromScale(0.5, 0.903)
			--}):Play()
	
			--ts:Create(getgenv().Baiyan.Open.UIStroke, TweenInfo.new(1), {
			--	Transparency = 1
			--}):Play()
			--ts:Create(getgenv().Baiyan.Open, TweenInfo.new(1), {
			--	TextTransparency = 1
			--}):Play()
		end}
	}
	...
	local function loadThemeFromSave(last)
		...
		if BaiyanPointSave:get("BaiyanGlobal_themeCode") then
			local themeObjectImport = themeDeserialize(https:JSONDecode(fu.from_base64(BaiyanPointSave:get("BaiyanGlobal_themeCode"))))
			theme:setColorTable(themeObjectImport)
			theme:init(getgenv().Baiyan)
	...
	table.insert(module, {
		...
		Args = {
			...
			function(obj, value)
				...
				BaiyanPointSave:set("BaiyanGlobal_themeCode", value)
			end
		}
	})
	...
	table.insert(module, {
		...
		Args = {"Delete theme from save", function()
			BaiyanPointSave:remove("BaiyanGlobal_themeCode")
	...
	--		return https:JSONDecode(game:HttpGet("https://github.com/Baiyanscript/roblox-script/raw/refs/heads/main/error"))
	--	end)
	...
	--table.insert(module, {
	--	Type = "Toggle",
	--	Args = {"Hide Baiyan+/Developer tags", function(_, state)
	...
	--table.insert(module, {
	--	Type = "Dropdown",
	--	Args = {"how rizz is Baiyan", {"very rizz", "no rizz"}, function(Self, item)
	--		print(item)
	--	end,}
	--})
...
local function DSZIHQM_routine() -- Routine: StarterGui.Baiyan.Init
    local script = Instance.new("LocalScript")
    script.Name = "Init"
    script.Parent = Converted["_Baiyan"]
    local req = require
	...
	getgenv().Baiyan = script.Parent
	getgenv().ThemeManager = require(script.Parent.Theme)
	local COREGUI = game:GetService("CoreGui")
	function BaiyanString()
		local length = math.Baiyan(10,20)
		local array = {}
		for i = 1, length do
			array[i] = string.char(math.Baiyan(32, 126))
		end
	...
	local s, e = pcall(function()
		if get_hidden_gui or gethui then
			...
			script.Parent.Name = BaiyanString()
			script.Parent.Parent = hiddenUI()
			--print("[Baiyan] - Using get_hidden_gui for anti-detection.")
		elseif (not is_sirhurt_closure) and (syn and syn.protect_gui) then
			script.Parent.Name = BaiyanString()
			syn.protect_gui(script.Parent)
			script.Parent.Parent = COREGUI
			--print("[Baiyan] - Using syn.protect_gui for anti-detection.")
		elseif COREGUI:FindFirstChild('RobloxGui') then
			script.Parent.Parent = COREGUI.RobloxGui
			--print("[Baiyan] - Using RobloxGui for anti-detection.")
		else
			--warn("[Baiyan] - Using CoreGui as anti-detection. This is the most basic coverage and can still be detected.")
		end
	end)
	
	--print("[Baiyan] - Baiyan is now in " .. tostring(script.Parent:GetFullName()))
	if not s then
		--warn("[Baiyan] - Attempts at anti-detection failed. Using CoreGui as anti-detection.")
		warn(e)	
	end
	
	--printidentity("[Baiyan] - Your executor level (identity) is")
	
	local getExeName = identifyexecutor or getexecutorname or function() return "Yet Another Roblox Executor v1.2" end
	--print("[Baiyan] - Your executor is " .. getExeName())
	...
	--require(script.Parent.FUNCTIONS).notification("Welcome to Baiyan Nebula.")
	...
	--require(script.Parent.Theme):init(getgenv().Baiyan)
...
local function EXEKBZ_routine() -- Routine: StarterGui.Baiyan.Forsaken
    local script = Instance.new("LocalScript")
	...
	local fu = require(getgenv().Baiyan.FUNCTIONS)
	if (module.gameId ~= game.GameId) then
		table.insert(module, {
			Type = "Text",
			Args = {"Baiyan now includes an official <font color='#FFFF00'>Forsaken</font> module!"}
		})
		table.insert(module, {
			Type = "Text",
			Args = {"<font size='10'>To use, run Baiyan on Forsaken.</font>"}
		})
		repeat task.wait() until getgenv().Modules
...
local function XXZOB_routine() -- Routine: StarterGui.Baiyan.Murder Mystery 2
    local script = Instance.new("LocalScript")
	...
	local function getPredictedPosition(player, shootOffset)
		...
		if predictionAIEngine and not usingBasicPred and not predictionCooldown and getgenv().BaiyanNetwork_predictPos then
			if (playerPosition - localplayer.Character:FindFirstChild("UpperTorso").Position).Magnitude > 20 then
				...
				local predictedPosition = getgenv().BaiyanNetwork_predictPos(ogplayer)
		...
		elseif predictionAIEngine and not getgenv().BaiyanNetwork.predictPos then
			fu.notification("Baiyan AI Engine is not available. Reverting to basic prediction.")	
		end
	...
	--					task.wait(0.1)
	--					local murderer = findMurderer() or findSheriffThatsNotMe()
	--					if not murderer then warn("[Baiyan] > MM2 Autoshoot - No murderer.") continue end
	--					local murdererPosition = murderer.Character.HumanoidRootPart.Position
	--					local characterRootPart = localplayer.Character.HumanoidRootPart
		...
		Args = {2, {
			...
			Teleport_to_map = function(Self)
				...
				if spawnsFolder then
					...
					local BaiyanSpawn = spawns[math.Baiyan(1, #spawns)]
					localplayer.Character:MoveTo(BaiyanSpawn.Position)
				else
	...
	table.insert(module, {
		...
		Args = {"Kill closest player as murderer", function()
			...
			if not simulateKnifeThrow then
				...
				--end
				--if math.Baiyan(0, 10) == 5 then -- idk what the fuk im doing
...
local function ONOAH_routine() -- Routine: StarterGui.Baiyan.Open.InitOpen
    local script = Instance.new("LocalScript")
...
local function JFQXCG_routine() -- Routine: StarterGui.Baiyan.Open.OnClick
    local script = Instance.new("LocalScript")
    script.Name = "OnClick"
    script.Parent = Converted["_Open"]
    local req = require
	...
	script.Parent.MouseButton1Click:Connect(function()
		...
		if clickCount == 3 then
			...
			ts:Create(getgenv().Baiyan.Menu, TweenInfo.new(0.7, Enum.EasingStyle.Back, Enum.EasingDirection.Out), 
...
local function EJGX_routine() -- Routine: StarterGui.Baiyan.Open.Resizer
    local script = Instance.new("LocalScript")
    script.Name = "Resizer"
    script.Parent = Converted["_Open"]
    local req = require
...
local function FRPPL_routine() -- Routine: StarterGui.Baiyan.FloatingButton.Keybinding
    local script = Instance.new("LocalScript")
...
local function VOBA_routine() -- Routine: StarterGui.Baiyan.FloatingButton.Invisible
    local script = Instance.new("LocalScript")
...
local function SZSARYI_routine() -- Routine: StarterGui.Baiyan.AddCustomModule.Add.LocalScript
    local script = Instance.new("LocalScript")
	...
	task.wait(1.5)
	if game.gameId == 5794311181 then loadModule("https://github.com/Baiyanscript/roblox-script/raw/refs/heads/main/error") end -- CNA Simulator
end
local function UVBTWP_routine() -- Routine: StarterGui.Baiyan.AddCustomModule.Cancel.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function HCWF_routine() -- Routine: StarterGui.Baiyan.Menu.UIStroke.UIGradient.Animator
    local script = Instance.new("LocalScript")
...
local function AWDPHWS_routine() -- Routine: StarterGui.Baiyan.Menu.CloseArea.CloseOpen
    local script = Instance.new("LocalScript")
...
local function VTLALB_routine() -- Routine: StarterGui.Baiyan.Menu.List.AutoSetup
    local script = Instance.new("LocalScript")
...
local function TVLRH_routine() -- Routine: StarterGui.Baiyan.Menu.List.AddCustomModule.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function KUFNO_routine() -- Routine: StarterGui.Baiyan.FloatingButtonSetting.ControlBarContainer.ControlBar.Visibility.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
	...
	script.Parent.MouseButton1Click:Connect(function()
		getgenv().BaiyanFUNCTIONS.ftToggleVisibility()
	end)
end
local function XLYNZG_routine() -- Routine: StarterGui.Baiyan.FloatingButtonSetting.ControlBarContainer.ControlBar.Lock.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
	...
	script.Parent.MouseButton1Click:Connect(function()
		getgenv().BaiyanFUNCTIONS.ftToggleLock()
	end)
end
local function XAPKH_routine() -- Routine: StarterGui.Baiyan.FloatingButtonSetting.ControlBarContainer.ControlBar.Exit.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
	...
	script.Parent.MouseButton1Click:Connect(function()
		getgenv().BaiyanFUNCTIONS.closeFinetuneFB()
	end)
end
