...
restoreBtn.Image = "rbxassetid://70869600792415"
...
local tool = Instance.new("Tool")
tool.Name = "過來"          -- Name of the tool
tool.RequiresHandle = false   -- Set true if you want to create a handle
tool.Parent = backpack        -- Put the tool in the player's inventory


local tool = Instance.new("Tool")
tool.Name = "指"          -- Name of the tool
tool.RequiresHandle = false   -- Set true if you want to create a handle
tool.Parent = backpack        -- Put the tool in the player's inventory


local tool = Instance.new("Tool")
tool.Name = "彈指"          -- Name of the tool
tool.RequiresHandle = false   -- Set true if you want to create a handle
tool.Parent = backpack        -- Put the tool in the player's inventory


local tool = Instance.new("Tool")
tool.Name = "倒數"          -- Name of the tool
tool.RequiresHandle = false   -- Set true if you want to create a handle
tool.Parent = backpack        -- Put the tool in the player's inventory


local tool = Instance.new("Tool")
tool.Name = "指自己"          -- Name of the tool
tool.RequiresHandle = false   -- Set true if you want to create a handle
tool.Parent = backpack        -- Put the tool in the player's inventory
...
local tool = Instance.new("Tool")
tool.Name = "思考"          -- Name of the tool
tool.RequiresHandle = false   -- Set true if you want to create a handle
tool.Parent = backpack        -- Put the tool in the player's inventory


local tool = Instance.new("Tool")
tool.Name = "槍"          -- Name of the tool
tool.RequiresHandle = false   -- Set true if you want to create a handle
tool.Parent = backpack        -- Put the tool in the player's inventory


local tool = Instance.new("Tool")
tool.Name = "和平"          -- Name of the tool
tool.RequiresHandle = false   -- Set true if you want to create a handle
tool.Parent = backpack        -- Put the tool in the player's inventory


local tool = Instance.new("Tool")
tool.Name = "停止"          -- Name of the tool
tool.RequiresHandle = false   -- Set true if you want to create a handle
tool.Parent = backpack        -- Put the tool in the player's inventory


local tool = Instance.new("Tool")
tool.Name = "好的"          -- Name of the tool
tool.RequiresHandle = false   -- Set true if you want to create a handle
tool.Parent = backpack        -- Put the tool in the player's inventory


local tool = Instance.new("Tool")
tool.Name = "輕敲"          -- Name of the tool
tool.RequiresHandle = false   -- Set true if you want to create a handle
tool.Parent = backpack        -- Put the tool in the player's inventory


local tool = Instance.new("Tool")
tool.Name = "抱頭"          -- Name of the tool
tool.RequiresHandle = false   -- Set true if you want to create a handle
tool.Parent = backpack        -- Put the tool in the player's inventory


local tool = Instance.new("Tool")
tool.Name = "不"          -- Name of the tool
tool.RequiresHandle = false   -- Set true if you want to create a handle
tool.Parent = backpack        -- Put the tool in the player's inventory


local tool = Instance.new("Tool")
tool.Name = "來"          -- Name of the tool
tool.RequiresHandle = false   -- Set true if you want to create a handle
tool.Parent = backpack        -- Put the tool in the player's inventory


local tool = Instance.new("Tool")
tool.Name = "是"          -- Name of the tool
tool.RequiresHandle = false   -- Set true if you want to create a handle
tool.Parent = backpack        -- Put the tool in the player's inventory


local tool = Instance.new("Tool")
tool.Name = "爆裂"          -- Name of the tool
tool.RequiresHandle = false   -- Set true if you want to create a handle
tool.Parent = backpack        -- Put the tool in the player's inventory


local tool = Instance.new("Tool")
tool.Name = "不喜歡"          -- Name of the tool
tool.RequiresHandle = false   -- Set true if you want to create a handle
tool.Parent = backpack        -- Put the tool in the player's inventory
...
local tool = Instance.new("Tool")
tool.Name = "機關槍"          -- Name of the tool
tool.RequiresHandle = false   -- Set true if you want to create a handle
tool.Parent = backpack        -- Put the tool in the player's inventory
...
local tool = Instance.new("Tool")
tool.Name = "手槍"          -- Name of the tool
tool.RequiresHandle = false   -- Set true if you want to create a handle
tool.Parent = backpack        -- Put the tool in the player's inventory

local tool = Instance.new("Tool")
tool.Name = "大砲"          -- Name of the tool
tool.RequiresHandle = false   -- Set true if you want to create a handle
tool.Parent = backpack        -- Put the tool in the player's inventory

local tool = Instance.new("Tool")
tool.Name = "迷你槍"          -- Name of the tool
tool.RequiresHandle = false   -- Set true if you want to create a handle
tool.Parent = backpack        -- Put the tool in the player's inventory

local tool = Instance.new("Tool")
tool.Name = "手槍 1"          -- Name of the tool
tool.RequiresHandle = false   -- Set true if you want to create a handle
tool.Parent = backpack        -- Put the tool in the player's inventory
...
makeButton(page2, "打字動畫", function() 
...
game.StarterGui:SetCore("SendNotification", {
            Title = "FE 打字動畫 By Baiyan",
            Text = "此腳本在你聊天時運行打字和說話動畫",
            Duration = 5
        })
...
makeButton(page2, "夾娃娃機", function() 
...
textbox.PlaceholderText = "輸入遊玩回合"
...
----------------------------------------------------------------------
makeButton(page3, "大力士", function() 

--FE High Striker (R15 Only)
--By Baiyan

game.StarterGui:SetCore("SendNotification", {
            Title = "FE 大力士 By Baiyan",
            Text = "你可以問朋友他們想要多少回合！",
            Duration = 5
        })
...
makeButton(page3, "給狙擊槍", function() 

-- FE Give Sniper (Only R15)
-- By Baiyan

game.StarterGui:SetCore("SendNotification", {
Title = "FE 給狙擊槍 By Baiyan",
Text = "裝備工具並點擊目標玩家",
Duration = 5
})
...
makeButton(page3, "給錘子", function() 

--FE Give Hammer (Only R15)
--By Baiyan

game.StarterGui:SetCore("SendNotification", {
            Title = "FE 給錘子 By Baiyan",
            Text = "裝備工具並點擊目標玩家",
            Duration = 5
        })
...
makeButton(page3, "給鎬子", function() 

--FE Give Pick Axe (Only R15)
--By Baiyan

game.StarterGui:SetCore("SendNotification", {
            Title = "FE 給鎬子 By Baiyan",
            Text = "裝備工具並點擊目標玩家",
            Duration = 5
        })
...
makeButton(page3, "劍動畫", function() 

--FE Sword Animation (R15 Only)
--By Baiyan

game.StarterGui:SetCore("SendNotification", {
    Title = "FE 劍動畫 By Baiyan",
    Text = "裝備工具並點擊目標玩家",
    Duration = 5
})
...
local tool = Instance.new("Tool")
tool.Name = "斬擊"          -- Name of the tool
tool.RequiresHandle = false   -- Set true if you want to create a handle
tool.Parent = backpack        -- Put the tool in the player's inventory

local tool = Instance.new("Tool")
tool.Name = "斬擊 2"          -- Name of the tool
tool.RequiresHandle = false   -- Set true if you want to create a handle
tool.Parent = backpack        -- Put the tool in the player's inventory
...
makeButton(page3, "無頭 & Korblox", function() 
...
makeButton(page3, "Minecraft動畫", function() 
...
makeButton(page4, "神秘人", function()

--FE Mysterious Guy (R15)
--By Baiyan

game.StarterGui:SetCore("SendNotification", {
    Title = "FE 神秘人 By Baiyan",
    Text = "裝備工具並點擊目標玩家",
    Duration = 5
})
...
makeButton(page4, "警察", function()

--FE Police Officer (R15)
--By Baiyan

game.StarterGui:SetCore("SendNotification", {
    Title = "FE 警察 By Baiyan",
    Text = "裝備工具並點擊目標玩家",
    Duration = 5
})
...
makeButton(page4, "無人機", function()

--FE Drone (R15)
--By Baiyan

game.StarterGui:SetCore("SendNotification", {
    Title = "FE 無人機 By Baiyan",
    Text = "按住跳躍如果你想飛更高",
    Duration = 5
})
...
makeButton(page5, "詭異生物", function()
...
makeButton(page5, "頭部寵物", function()
--FE Head Pet (R15)
--By Baiyan
...
makeButton(page6, "故障者", function()
-- FE Glitcher (R15)
-- By Baiyan

game.StarterGui:SetCore("SendNotification", {
    Title = "FE 故障者 By Baiyan",
    Text = "你的角色移動會延遲/故障",
    Duration = 5
})
...
makeButton(page6, "瘋狂舞蹈", function()
--FE Crazy Dance (R15)
--By Baiyan
...
makeButton(page7, "折磨", function()
--FE Torture (R15 Only)
--By Baiyan

game.StarterGui:SetCore("SendNotification", {
    Title = "FE 折磨 By Baiyan",
    Text = "裝備工具並點擊目標玩家",
    Duration = 5
})
...
makeButton(page8, "Mm2套裝", function()
--FE Mm2 Set (R15)
--By Baiyan
